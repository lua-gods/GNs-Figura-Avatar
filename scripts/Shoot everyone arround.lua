...
mac.TICK:register(function ()
   local entities = world.getNearbyEntities(5,player:getPos())
   for key, entity in pairs(entities) do
      if entity:getType() == "minecraft:chicken" then
         local pos = (entity:getPos() + entity:getVelocity() - player:getPos()):sub(0,player:getEyeHeight()):normalize()
         local stringVel = {}
         local vel = pos * 10
